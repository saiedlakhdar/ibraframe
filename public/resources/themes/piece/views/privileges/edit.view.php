        ...
        <form method="post">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <input class="form-control" name="name" placeholder="<?= $privileges_text_name ; ?>" type="text" value="<?= $privileges->name ; ?>" required>
                </div>
                <div class="form-group col-md-12">
                    ...
                    <?php  if (isset($permissions) && false !== $permissions ) : foreach ($permissions as $permission) :    ?>
                        <label class="container-checkbox"><?= $permission->name ;?>
                            <input type="checkbox" <?= in_array($permission->id, $extractepermissions) ? 'checked="checked"': '' ;  ?>  name="privileges[]" id="privilege<?= $permission->id ;?>" value="<?= $permission->id ;?>" >
