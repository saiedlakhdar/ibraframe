        ...
        <form method="post">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input class="form-control" name="name" placeholder="<?= $permissions_text_name ; ?>" type="text" value="<?= $permissions->name ; ?>" required>
                </div>
                <div class="form-group col-md-6">
                    <input class="form-control" name="scope" placeholder="<?= $permissions_text_scope ; ?>" type="text" value="<?= $permissions->scope ; ?>" required>
                </div>
