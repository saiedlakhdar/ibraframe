...
//            var_dump($user);
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input class="form-control" name="phone" placeholder="<?= $users_text_phone ; ?>" type="tel" value="<?= $this->priorFieldValue('phone' ,$user ) ;?>" required>
                </div>
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" name="rule" required>
                        ...
                        <option <?= $this->priorOptionValue('rule',$usergroup->id, $user) ; ?> value="<?= $usergroup->id ; ?>"><?= $usergroup->name ; ?></option>
                        <?php endforeach;   ?>
                    </select>
                    <?php  endif;  ?>
                </div>
            ...
            <div class="form-row ">
                <div class="form-group col-md-2">
                    <button type="submit" name="submit" class="btn btn-outline-primary btn-block"><?= $users_text_save ; ?></button>
                </div>
